      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-xs text-slate-400 font-sans font-semibold tracking-wider uppercase mb-3">
            ...
            <div className="flex flex-wrap gap-2 text-[11px] font-sans">
              ...
              <span className="px-2.5 py-1 rounded bg-slate-900 border border-slate-800 text-blue-400 font-medium">
                NBA & NAAC
              </span>
            </div>
          </div>
          ...
          <div>
            <h4 className="text-white font-sans text-xs uppercase tracking-wider font-bold mb-3 border-l-2 border-cyan-400 pl-2">
              Electronics Club
            </h4>
            <ul className="space-y-2 text-xs font-sans text-slate-400">
              <li><span className="text-slate-200 font-medium">CLUE QUEST Challenge</span></li>
              <li><span>ArduFusion Project Expo</span></li>
              <li><span>Crack & Act Competition</span></li>
              <li><span>Wokwi Circuit Simulation</span></li>
              <li><span>PCB Design Workshops</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-xs font-sans">
              ...
              <p className="flex items-center gap-2">
                ...
                <span className="font-mono text-[11px]">hod.ece@vsbec.edu.in</span>
              </p>
